var c="ABCDEFGHIJKLMNOPQRSTUVWXYZ123456789!@#$%^&*~`/.,<>?\|]}{["
...
animate = () => {
  ...
  for (let i = 0; i < letter.length; i++) {
    ...
    let rH = mR(540, 10)
    let sH = mR(rH, 1)
    letter[i][6] == 2 ? dR(letter[i][0], letter[i][1]-sH, letter[i][3]/1.5, rH, "rgba(0, 0, 255, 0.1)"): null
  }
  dT(can.width/2, can.height/2, "Move your mouse.", 20, 1)
}
